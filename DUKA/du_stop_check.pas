...
Day,S,week_day,Date,PositionX,PositionX_ASK,week_day_ini,Profit_ini,Loss_ini,qv_ini,calendar,history_0,history_1,spread_ini,tau_0_ini,week:string;
...
writeln(f3,'Profit (max) = ',Profit*10000*53:3:2);
