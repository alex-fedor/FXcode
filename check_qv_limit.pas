...
Day,S,week_day,Date,PositionX,week_day_ini,Profit_ini,Loss_ini,qv_ini,calendar,history:string;
...
q_Volat,Volatility,{Coef,}Profit,Loss,qv:real;
...
assign(f3,'report_limit_'+ week_day_ini +'.csv');
rewrite(f3);
