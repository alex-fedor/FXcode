...
assign(f3,'d' + week_day_ini + 'L_FindLoss' + '_['+ tau_0_ini +'^' + tau_X_ini +']' + '_{' + week + '}.csv');
rewrite(f3);
...
begin
if (MinP[i] + spread >= BuyLimit_Open) then BuyLimit_Floating_PL:=MaxP[i] - BuyLimit_Open;{GOOD!}
if (MaxP[i] + spread <  BuyLimit_Open) then BuyLimit_Floating_PL:=MinP[i] - BuyLimit_Open;{GOOD!}
if (MinP[i] + spread <  BuyLimit_Open) then BuyLimit_Floating_PL:=MinP[i] - BuyLimit_Open;{THINKING...}
...
begin
if (MaxP[i] <= SellLimit_Open) then SellLimit_Floating_PL:=SellLimit_Open - MinP[i] - spread;{GOOD!}
if (MinP[i] >  SellLimit_Open) then SellLimit_Floating_PL:=SellLimit_Open - MaxP[i] - spread;{GOOD!}
if (MaxP[i] >  SellLimit_Open) then SellLimit_Floating_PL:=SellLimit_Open - MaxP[i] - spread;{THINKING...}
